...
<html lang="cs-cz">
    ...
    <body>
        ...
        <article>
                <h2>O aplikaci</h2>
                <p>Tato aplikace byla vytvořena v rámci rekvalifikačního kurzu PHP programátor WWW aplikací společností <a href="https://www.itnetwork.cz" target="blank" >IT network.</a></p>
            <?php 
